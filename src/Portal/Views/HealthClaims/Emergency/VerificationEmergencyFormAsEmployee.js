...
export default function VerificationEmergencyFormAsEmployee(props) {
    ...
    async function onSubmit(dataform,e){
        ...
        try{
            ...
            navigate(`/app/siniestro_salud/solicitud_ingreso/${data.verificationId}`);
        }catch(error){
            console.error(error)
        }
    }
            ...
            <CardPanel titulo="Verificación de Asegurabilidad por Emergencia" icon="local_hospital" iconColor="primary">
                ...
                <CardFooter>
                    ...
                    <Button color="primary" type="submit">
                        <Icon>send</Icon> Solicitar Ingreso
                    </Button>
                    </GridContainer>
                </CardFooter>
            </CardPanel>
