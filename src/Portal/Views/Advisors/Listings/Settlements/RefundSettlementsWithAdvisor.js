...
export default function RefundSettlementsWithAdvisor() {
    ...
    return (
        ...
        <GridItem xs={12} sm={12} md={12} lg={6}>
             <RefundSettlementsSearch  handleSettlements={handleSettlements} handleIsLoading={handleIsLoading} showAdvisors={true}/>
        </GridItem>
