    ...
    return (
        <TableMaterial
            ...
            columns={[
                ...
                { title: 'Estatus', field: 'STATUS_FOR_COLORS', render: rowData => <Badge color={statusColors[rowData.STATUS_FOR_COLORS].color ? statusColors[rowData.STATUS_FOR_COLORS].color : ""}>{rowData.STATUS_FOR_COLORS}</Badge>  }
            ]}
            data={services}
            isLoading = {isLoading}
