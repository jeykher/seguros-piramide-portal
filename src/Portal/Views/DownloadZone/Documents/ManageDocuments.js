...
import ManageDocumentsForm from "./ManageDocumentsForm"
    ...
    <GridContainer>
      <GridItem xs={12} sm={12} md={12} lg={12}>
        {viewTable && <Slide in={true} direction='up' timeout={1000}>
          <div>
            <CardPanel titulo="Administrar Documentos" icon="library_books" iconColor="primary">
              <ManageDocumentsTable handleClickAdd={handleClickAdd}/>
            </CardPanel>
          </div>
        </Slide>}
        {viewForm && <ManageDocumentsForm/>}
      </GridItem>
      {!viewTable &&
