...
import CustomerPersonalTravel from 'Portal/Views/Customer/CustomerPersonalTravel'
...
const TravelerForm = forwardRef((props, ref) => {
    ...
    return (
        <form key={index} noValidate autoComplete="off" className={classes.root}>
            <CardPanel titulo={title} icon="airline_seat_recline_extra" iconColor="primary" >
                <GridContainer className={classes.root}>
                    <GridItem item xs={12} sm={12} md={12} lg={12}>
                        ...
                        />
                        {objCustomer.showForm && <CustomerPersonalTravel
                            index={index} 
                            objForm={objForm}
                            customerType={customerType}
