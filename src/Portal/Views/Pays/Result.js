...
export default function Result(props) {
  const { income, handleBack, titleButton, reportId} = props
    ...
    <Fragment>
      <GridContainer justify={"center"}>
        <Alert severity={income ? "success" : "warning"}>
          <p>{income ? 'Su pago fue realizado éxitosamente' : 'Su pago fue rechazado, comuniquese con su institución financiera'}</p>
        </Alert>
