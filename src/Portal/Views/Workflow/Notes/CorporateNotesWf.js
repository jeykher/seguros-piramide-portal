...
export default function CorporateNotesWf(props) {
    ...
    async function onSubmit(dataform, e) {
        ...
        try {
            ...
            const result = await Axios.post('/dbo/general_claims/save_note_by_sinister', params)
    ...
    return (
        <GridContainer>
            ...
            <GridItem xs={12} sm={12} md={7} lg={7}>
                <CardPanel titulo="Notas Corporativas" icon="search" iconColor="primary" >
